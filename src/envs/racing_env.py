...
class RacingEnv:
    def __init__(
        ...
        self.u_min = torch.tensor([acc_min, steer_min], device=self._device, dtype=self._dtype)
        self.u_max = torch.tensor([acc_max, steer_max], device=self._device, dtype=self._dtype)
